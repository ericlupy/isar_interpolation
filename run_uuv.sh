...
PATH_TO_VERISIG_OUTPUT="uuv_verisig_output"
RATIO=0.25
PATH_TO_PARTITION_CSV="uuv_initial_state_regions.csv"
PATH_TO_SAMPLE_RESULT_CSV="uuv_sampling_result.csv"
PATH_TO_VERISIG_PARSED_CSV="uuv_verisig_result.csv"
N_SAMPLES=10
PATH_TO_OUTPUT="uuv_output"
PATH_TO_REPAIRED_CONTROL_NETWORK_YML="uuv_output/uuv_repaired_network.yml"
PATH_TO_REPAIRED_SAMPLE_RESULT_CSV="uuv_sampling_repaired_result.csv"
PATH_TO_REPAIRED_VERISIG_OUTPUT="uuv_verisig_repaired_output"
PATH_TO_REPAIRED_VERISIG_PARSED_CSV="uuv_verisig_repaired_result.csv"
