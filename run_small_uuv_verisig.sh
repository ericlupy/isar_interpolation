...
BENCHMARK="uuv"
PATH_TO_CONTROL_NETWORK_YML="uuv_output/repaired_network_small.yml" # replace it with the network to be verified, e.g. the repaired network
...
PATH_TO_VERISIG_OUTPUT="uuv_verisig_repaired_output_small" # replace it with the path of Verisig output you want
