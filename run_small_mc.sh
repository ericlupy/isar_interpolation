...
PATH_TO_VERISIG_OUTPUT="mc_verisig_output_small"
RATIO=0.25
PATH_TO_PARTITION_CSV="mc_initial_state_regions_small.csv"
PATH_TO_SAMPLE_RESULT_CSV="mc_sampling_result_small.csv"
PATH_TO_VERISIG_PARSED_CSV="mc_verisig_result_small.csv"
N_SAMPLES=10
PATH_TO_OUTPUT="mc_output_small"
PATH_TO_REPAIRED_CONTROL_NETWORK_YML="mc_output_small/mc_repaired_network_small.yml"
PATH_TO_REPAIRED_SAMPLE_RESULT_CSV="mc_sampling_repaired_result_small.csv"
PATH_TO_REPAIRED_VERISIG_OUTPUT="mc_verisig_repaired_output_small"
PATH_TO_REPAIRED_VERISIG_PARSED_CSV="mc_verisig_repaired_result_small.csv"
