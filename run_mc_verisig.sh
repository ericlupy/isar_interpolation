...
BENCHMARK="mc"
PATH_TO_CONTROL_NETWORK_YML="mc_output/repaired_network.yml" # replace it with the network to be verified, e.g. the repaired network
...
PATH_TO_VERISIG_OUTPUT="mc_verisig_repaired_output" # replace it with the path of Verisig output you want
